...
const filesToUpload = [
    ...
    { local: 'icons/icon-72x72.png', remote: `${APP_DIR}/icons/icon-72x72.png` },
    { local: 'icons/icon-96x96.png', remote: `${APP_DIR}/icons/icon-96x96.png` },
    { local: 'icons/icon-128x128.png', remote: `${APP_DIR}/icons/icon-128x128.png` },
    { local: 'icons/icon-144x144.png', remote: `${APP_DIR}/icons/icon-144x144.png` },
    { local: 'icons/icon-152x152.png', remote: `${APP_DIR}/icons/icon-152x152.png` },
    { local: 'icons/icon-192x192.png', remote: `${APP_DIR}/icons/icon-192x192.png` },
    { local: 'icons/icon-384x384.png', remote: `${APP_DIR}/icons/icon-384x384.png` },
    { local: 'icons/icon-512x512.png', remote: `${APP_DIR}/icons/icon-512x512.png` },
    { local: 'icons/icon-maskable-192x192.png', remote: `${APP_DIR}/icons/icon-maskable-192x192.png` },
    { local: 'icons/icon-maskable-512x512.png', remote: `${APP_DIR}/icons/icon-maskable-512x512.png` },
